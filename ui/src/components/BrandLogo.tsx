...
export function BrandLogo({
  ...
  if (mark) {
    return (
      ...
      <img src="/dograh-mark.png" alt="Hopwhistle AI Voice" className={cn("w-auto select-none", className)} />
    );
  }
  if (inverse) {
    return (
      // eslint-disable-next-line @next/next/no-img-element
      <img src="/dograh-logo-inverse.png" alt="Hopwhistle AI Voice" className={cn("w-auto select-none", className)} />
    );
  }
  return (
    <>
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src="/dograh-logo.png" alt="Hopwhistle AI Voice" className={cn("block w-auto select-none dark:hidden", className)} />
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src="/dograh-logo-inverse.png" alt="Hopwhistle AI Voice" className={cn("hidden w-auto select-none dark:block", className)} />
    </>
  );
}
